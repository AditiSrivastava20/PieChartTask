...
class ShowExpenseViewController: UIViewController, UITableViewDataSource {

    @IBOutlet weak var expandTableView: UITableView!
    var expandedSections : NSMutableSet = []
    var sectionData : [String] = ["product1", "product2",  "product3", "product4"]
...
extension ShowExpenseViewController: UITableViewDelegate, UITextFieldDelegate {
